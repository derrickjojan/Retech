...
if (!empty($_SESSION['userid'])) {
    ...
    if (isset($_POST['submit'])) {
      ...
      if (mysqli_num_rows($select) > 0) {
          ...
          $insert = mysqli_query($conn, "INSERT INTO `tbl_Card`(Customer_id,Card_number, Card_holder, Expiry_date, Card_cvv) VALUES ('$user_id', '$cnumber', '$cholder', '$formattedDate', '$ccvv')");
