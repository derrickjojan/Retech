...
$sql_check_isavail = "SELECT * FROM tbl_Customer where Customer_id = '$user_id'";
$result_check_isavail = mysqli_query($conn, $sql_check_isavail);


if (mysqli_num_rows($result_check_isavail) == 1) {
    $sql_update = "UPDATE tbl_Customer SET cust_phno='$phno_fetched', cust_fname='$fname_fetched', cust_mname='$mname_fetched', cust_lname='$lname_fetched', cust_dist='$dist_fetched', cust_city='$city_fetched', cust_pin='$pin_fetched'
      WHERE Customer_id='$user_id'";

if (mysqli_query($conn, $sql_update)) {
  echo "Record updated successfully";
  
$sql_displayValues = "SELECT * FROM tbl_Customer where Customer_id = '$user_id'";
