...
<body>
    <div class="container">
        <div class="header">
            <h3>Category List</h3>
            <div class="">
                <a href="addcat.php" class="btn"> Create New</a>
            </div>
        </div>
        <div class="table">
            <table>
    ...
    <script>
        function printAndClose() {
            var printWindow = window.open("print_cat.php", "_blank");
        ...
        function exportToExcel() {
            fetch('viewcat.php') // Fetch data from viewcust.php
  ...
  .page {
        ...
        editLinks.forEach(function (editLink) {
            editLink.addEventListener('click', function (event) {
                ...
                var url = 'managecat.php?id=' + itemId;
