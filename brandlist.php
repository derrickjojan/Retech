...
<body>
    <div class="container">
        <div class="header">
            <h3>List of Brand</h3>
            <div class="">
                <a href="addbrand.php" class="btn"> Create New</a>
            </div>
        </div>
        <div class="table">
            <table>
                ...
                <?php
$i = 1;
$qry = mysqli_query($conn, "SELECT b.Brand_id, b.Brand_name, GROUP_CONCAT(i.Item_id) AS Item_ids
                            FROM tbl_Brand b
                            LEFT JOIN tbl_Item i ON b.Brand_id = i.Brand_id
...
while ($row = mysqli_fetch_assoc($qry)):
    ...
    // Check if there are associated items with the brand
    $hasItems = !empty($row['Item_ids']);
        ...
        <td align="center">
            <div class="dp">
                ...
                <div class="dp-content">
                    ...
                    <?php
                    // Display the delete button only if there are no associated items
                    if (!$hasItems) {
                        echo '<a href="#" class="delete-link" data-item-id="' . $id . '">Delete</a>';
                    }
                    ?>
                </div>
            </div>
...
<?php endwhile; ?>
    ...
    <script>
        function printAndClose() {
            var printWindow = window.open("print_brand.php", "_blank");
        ...
        function exportToExcel() {
            fetch('viewbrand.php') // Fetch data from viewcust.php
                ...
                .then(data => {
                    ...
                    ws['!cols'] = wscols;
                    XLSX.writeFile(wb, 'Brand_report.xlsx');
                })
                .catch(error => {
  ...
  .page {
        ...
        $qry = mysqli_query($conn,"SELECT * FROM `tbl_Brand`");
        ...
        editLinks.forEach(function (editLink) {
            editLink.addEventListener('click', function (event) {
                ...
                var url = 'managebrand.php?id=' + itemId;
        ...
        deleteLinks.forEach(function (deleteLink) {
            deleteLink.addEventListener('click', function (event) {
                ...
                if (confirmation) {
                    ...
                    console.log(itemId); // Check if itemId has the correct value
                    var url = 'delbrand.php?id=' + itemId;
                    window.location.href = url;
                }
            });
        });
