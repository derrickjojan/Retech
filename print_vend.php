...
<body>
    <div class="container">
        ...
        $qry = mysqli_query($conn, "SELECT * FROM `tbl_Vendor` ORDER BY Vendor_id");
                ...
                <div class="table">
                    ...
                    <colgroup>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['Vendor_Fname'] ?> <?php echo $row['Vendor_Mname'] ?></td>
                            <td><?php echo $row['Vendor_Phno'] ?></td>
